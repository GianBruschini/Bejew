...
public class Play extends AppCompatActivity {
    ...
    public void onBackPressed(){
        ...
        builder.setPositiveButton("Si", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                finish();
                Intent intent = new Intent(Play.this , Inicio.class);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if(estado == 1) {
                    if(controlDeJuego()){
                        Play.this.barrido();
                        Play.this.marcarImagenes();
                        estado = estado + 1;
                        handler.postDelayed(this, 700);

                    } else{
                        Play.this.cascadaEnCurso=false;
                        Button r = findViewById(R.id.finish);
                        r.setEnabled(true);
                    }
            ...
            for (int y = 0; y < matriz[x].length; y++) {
                ...
                grilla.getChildAt(ubicacion).setOnClickListener(new View.OnClickListener() {  //a cada imagen seteada en la matriz le asigno un onClickListener, es decir que cuando se haga click va a responder a cierto "evento/logica"
                    ...
                    public void onClick(View v) {
                        Play.this.onGemaClick(v,posX, posY);
    ...
    public void onBackPressed2(){
        ...
        builder.setMessage("Do you want to finish the current match?");
    ...
    public void onBackPressed3(){
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                SharedPreferences sharedPref = getSharedPreferences("PREFS",Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPref.edit();
                editor.putInt("best", cont);
                editor.commit();
                Intent intent = new Intent ( Play.this , Ranking.class);
                startActivity(intent);
            }
        });
        builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
    ...
    public void onBackPressed4(){
        ...
        builder.setMessage("You haven`t passed the last score. Do you want to keep playing?");
        builder.setTitle("Ranking");
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
